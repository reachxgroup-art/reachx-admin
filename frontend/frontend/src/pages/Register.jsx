    ...
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-medium text-white tracking-tight">Admin Panel</h1>
        ...
        <div className="bg-[#161b27] border border-white/[0.08] rounded-2xl p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-600 mt-1.5">Use 8 or more characters</p>
            </div>
            ...
            >
              {loading ? (
                <><span className="w-3.5 h-3.5 border-2 border-white/20 border-t-white rounded-full animate-spin" /> Creating account…</>
              ) : "Create account"}
            </button>
          </form>
